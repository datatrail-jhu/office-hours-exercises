...
It probably makes sense to combine the `champs` and `runners` data sets together into one dataframe since they have the same columns and similar information. 
